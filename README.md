...
- **Messaging/Real-time:** gRPC (Protocol Buffers) · Apache Kafka (KafkaJS) · WebSockets
- **Databases:** MongoDB (Mongoose, aggregation pipelines) · MySQL · SQL Server
- **Cloud/DevOps:** AWS (CloudWatch, Secrets Manager, S3) · Docker · Amazon Bedrock (RAG)
